...
public class GADAGo {
    ...
    public void start() {
        ...
        if (userLoggedIn) {
            ...
            Button friend1 = new Button (String.format("%-30s %s", "Cesar", "10.1 mi"));
            Button friend2 = new Button(String.format("%-30s %s", "Gina", "3.9 mi"));
            Button friend3 = new Button(String.format("%-30s %s", "Michael", "l4.5 mi"));
