...
public class GADAGo {
    ...
    Form profileForm;
    Set<Button> invitationsButtons = new HashSet<>();
        ...
        if (userLoggedIn) {
            ...
            for (Friend friend : myFriends.getAllFriends()) {
                ...
                friendButton.addActionListener((e) -> {
                    ...
                    SharedPrefsForm sharedPrefs = new SharedPrefsForm(friend, friendsForm, prefsButtonContainer, profileForm, invitationsButtons);
            ...
            viewInvites.addActionListener((ActionEvent e) -> {
                //Display.getInstance().execute("https://www.codenameone.com/developers.html");
                InvitationsForm invitationsForm1 = new InvitationsForm(invitationsButtons, profileForm);
                invitationsForm1.showForm();
            });
